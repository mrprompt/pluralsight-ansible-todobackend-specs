...
describe('Create Todo Item', function() {
  ...
  it('shoudl return a 201 CREATED response', function() {
...
describe('Delete Todo Item', function() {
  ...
  it('sould return a 204 NO CONTENT response', function() {
...
// GET request with data and return promise
...
// DELETE request with data and return promise
function del(url) {
...
// Reslve promise for property and return expectation
